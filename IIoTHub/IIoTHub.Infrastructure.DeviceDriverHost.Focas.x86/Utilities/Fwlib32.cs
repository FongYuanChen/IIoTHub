...
public class Focas1
{
    ...
    public const short EW_PROTOCOL = (short)focas_ret.EW_PROTOCOL;
    public const short EW_SOCKET = (short)focas_ret.EW_SOCKET;
    public const short EW_NODLL = (short)focas_ret.EW_NODLL;
    public const short EW_BUS = (short)focas_ret.EW_BUS;
    public const short EW_SYSTEM2 = (short)focas_ret.EW_SYSTEM2;
    public const short EW_HSSB = (short)focas_ret.EW_HSSB;
    public const short EW_HANDLE = (short)focas_ret.EW_HANDLE;
    public const short EW_VERSION = (short)focas_ret.EW_VERSION;
    public const short EW_UNEXP = (short)focas_ret.EW_UNEXP;
    public const short EW_SYSTEM = (short)focas_ret.EW_SYSTEM;
    public const short EW_PARITY = (short)focas_ret.EW_PARITY;
    public const short EW_MMCSYS = (short)focas_ret.EW_MMCSYS;
    public const short EW_RESET = (short)focas_ret.EW_RESET;
    public const short EW_BUSY = (short)focas_ret.EW_BUSY;
    public const short EW_OK = (short)focas_ret.EW_OK;
    public const short EW_FUNC = (short)focas_ret.EW_FUNC;
    public const short EW_NOPMC = (short)focas_ret.EW_NOPMC;
    public const short EW_LENGTH = (short)focas_ret.EW_LENGTH;
    public const short EW_NUMBER = (short)focas_ret.EW_NUMBER;
    public const short EW_RANGE = (short)focas_ret.EW_RANGE;
    public const short EW_ATTRIB = (short)focas_ret.EW_ATTRIB;
    public const short EW_TYPE = (short)focas_ret.EW_TYPE;
    public const short EW_DATA = (short)focas_ret.EW_DATA;
    public const short EW_NOOPT = (short)focas_ret.EW_NOOPT;
    public const short EW_PROT = (short)focas_ret.EW_PROT;
    public const short EW_OVRFLOW = (short)focas_ret.EW_OVRFLOW;
    public const short EW_PARAM = (short)focas_ret.EW_PARAM;
    public const short EW_BUFFER = (short)focas_ret.EW_BUFFER;
    public const short EW_PATH = (short)focas_ret.EW_PATH;
    public const short EW_MODE = (short)focas_ret.EW_MODE;
    public const short EW_REJECT = (short)focas_ret.EW_REJECT;
    public const short EW_DTSRVR = (short)focas_ret.EW_DTSRVR;
    public const short EW_ALARM = (short)focas_ret.EW_ALARM;
    public const short EW_STOP = (short)focas_ret.EW_STOP;
    public const short EW_PASSWD = (short)focas_ret.EW_PASSWD;

    public const short DNC_NORMAL = (short)focas_ret.DNC_NORMAL;
    public const short DNC_CANCEL = (short)focas_ret.DNC_CANCEL;
    public const short DNC_OPENERR = (short)focas_ret.DNC_OPENERR;
    public const short DNC_NOFILE = (short)focas_ret.DNC_NOFILE;
    public const short DNC_READERR = (short)focas_ret.DNC_READERR;
    ...
    public const short ODBPOS_DATA_NUMBER = 24;
#elif FS15D
    [StructLayout(LayoutKind.Sequential,Pack=4)]
    public class ODBPOS
    {
    ...
    public const short ODBPOS_DATA_NUMBER = 10;
#else
    [StructLayout(LayoutKind.Sequential, Pack = 4)]
    public class ODBPOS
    {
    ...
    public const short ODBPOS_DATA_NUMBER = 8;
#endif
    ...
    public const short ODBSPLOAD_DATA_NUMBER = 4;
    ...
    {
        public ODBPDFADIR_data data1 = new ODBPDFADIR_data();
        public ODBPDFADIR_data data2 = new ODBPDFADIR_data();
        public ODBPDFADIR_data data3 = new ODBPDFADIR_data();
        public ODBPDFADIR_data data4 = new ODBPDFADIR_data();
        public ODBPDFADIR_data data5 = new ODBPDFADIR_data();
        public ODBPDFADIR_data data6 = new ODBPDFADIR_data();
        public ODBPDFADIR_data data7 = new ODBPDFADIR_data();
        public ODBPDFADIR_data data8 = new ODBPDFADIR_data();
        public ODBPDFADIR_data data9 = new ODBPDFADIR_data();
        public ODBPDFADIR_data data10 = new ODBPDFADIR_data();
    }
    ...
    public const short OFS_1_DATA_NUMBER = 5;
    public const short OFS_1_LENGTH = 8 + 4 * OFS_1_DATA_NUMBER;
    [StructLayout(LayoutKind.Sequential, Pack = 4)]
    public class OFS_2
    {
    ...
    public const short OFS_2_DATA_NUMBER = 5;
    public const short OFS_2_LENGTH = 8 + 8 * OFS_2_DATA_NUMBER;
    [StructLayout(LayoutKind.Sequential, Pack = 4)]
    public class OFS_3
    {
    ...
    public const short OFS_3_DATA_NUMBER = 5;
    public const short OFS_3_LENGTH = 8 + 16 * OFS_3_DATA_NUMBER;
    [StructLayout(LayoutKind.Sequential, Pack = 4)]
    ...
    /* cnc_rdzofs:read work zero offset value for 8 axis*/
    /* cnc_wrzofs:write work zero offset value for 8 axis*/
    [StructLayout(LayoutKind.Sequential, Pack = 4)]
    public class IODBZOFS_1
    {
        public short datano;    /* offset NO. */
        public short type;      /* axis number */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8)]
        public int[] data = new int[8];       /* data value */
    }
    ...
    public const short IODBZOR_DATA_NUMBER = 7;
    public const short IODBZOR_LENGTH = 8 + 4 * MAX_AXIS * IODBZOR_DATA_NUMBER;

    /* cnc_rdzofsr:read work zero offset value(area specified) for 8 axis */
    /* cnc_wrzofsr:write work zero offset value(area specified) for 8 axis*/
    [StructLayout(LayoutKind.Sequential, Pack = 4)]
    public class IODBZOR_1
    {
        public short datano_s;  /* start offset number */
        public short type;      /* axis number */
        public short datano_e;  /* end offset number */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 7 * 8)]
        public int[] data = new int[7 * 8];      /* offset value */
    } /* In case that the number of axes is MAX_AXIS, the number of data is 7 */
    public const short IODBZOR_1_DATA_NUMBER = 7;
    public const short IODBZOR_1_LENGTH = 8 + 4 * MAX_AXIS * IODBZOR_DATA_NUMBER;
    ...
    public const short ODBM_LENGTH = 10;
    ...
    public const ushort ODBAHIS_DATA_NUMBER = 10;
    public const ushort ODBAHIS_LENGTH = 6 + 48 * ODBAHIS_DATA_NUMBER;
    ...
    public const ushort ODBAHIS5_DATA_NUMBER = 10;
    public const ushort ODBAHIS5_LENGTH = 4 + 516 * ODBAHIS5_DATA_NUMBER;
    ...
    public const short ODBALMMSG_DATA_NUMBER = 10;
    ...
    public const short ODBALMMSG2_DATA_NUMBER = 10;
    ...
    public const short PRGDIR3_DATA_NUMBER = 10;
    ...
    public const short ODBAXISNAME_DATA_NUMBER = 24;
#elif FS15D
    [StructLayout(LayoutKind.Sequential,Pack=4)]
    public class ODBAXISNAME
    {
    ...
    public const short ODBAXISNAME_DATA_NUMBER = 10;
#else
    [StructLayout(LayoutKind.Sequential, Pack = 4)]
    public class ODBAXISNAME
    {
    ...
    public const short ODBAXISNAME_DATA_NUMBER = 8;
#endif
    ...
    public const ushort IODBPMC0_DATA_NUMBER = 5;
    public const ushort IODBPMC0_LENGTH = 8 + 1 * IODBPMC0_DATA_NUMBER;
    ...
    public const ushort IODBPMC1_DATA_NUMBER = 5;
    public const ushort IODBPMC1_LENGTH = 8 + 2 * IODBPMC1_DATA_NUMBER;
    ...
    public const ushort IODBPMC2_DATA_NUMBER = 5;
    public const ushort IODBPMC2_LENGTH = 8 + 4 * IODBPMC2_DATA_NUMBER;
    ...
    /* read program name under execution 2*/
    [DllImport("Fwlib32.dll", EntryPoint = "cnc_exeprgname2")]
    public static extern short cnc_exeprgname2(ushort FlibHndl, [Out, MarshalAs(UnmanagedType.AsAny)] Object a);
    ...
    /* read directory (all files) */
    [DllImport("Fwlib32.dll", EntryPoint = "cnc_rdpdf_alldir")]
    public static extern short cnc_rdpdf_alldir(ushort FlibHndl, ref short a, [In, MarshalAs(UnmanagedType.LPStruct)] IDBPDFADIR b, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBPDFADIR c);
    ...
    /* write work zero offset value for 8 axis*/
    [DllImport("Fwlib32.dll", EntryPoint = "cnc_wrzofs")]
    public static extern short cnc_wrzofs(ushort FlibHndl, short a, [In, MarshalAs(UnmanagedType.LPStruct)] IODBZOFS_1 b);
    ...
    /* write work zero offset value(area specified) for 8 aixs*/
    [DllImport("Fwlib32.dll", EntryPoint = "cnc_wrzofsr")]
    public static extern short cnc_wrzofsr(ushort FlibHndl, short a, [In, MarshalAs(UnmanagedType.LPStruct)] IODBZOR_1 b);
    ...
    {
        BCode = 4102, // Indexing axis position
        DCode = 4107, // Cutter radius offset number
        ECode = 4108, // Feedrate value (if available)
        FCode = 4109, // Feedrate value
        HCode = 4111, // Tool length offset number
        MCode = 4113, // Miscellaneous function
        NCode = 4114, // Sequence number
        OCode = 4115, // Program number
        SCode = 4119, // Spindle speed value
        TCode = 4120, // Tool number
        PCode = 4130 // Additional work offset number
    }
    ...
    public static ODBSYS_CNC_TYPE cnc_type_convert(char[] value)
    {
        switch (new string(value).Trim())
        {
            case "15":
                return ODBSYS_CNC_TYPE.S15;
            case "16":
                return ODBSYS_CNC_TYPE.S16;
            case "18":
                return ODBSYS_CNC_TYPE.S18;
            case "21":
                return ODBSYS_CNC_TYPE.S21;
            case "30":
                return ODBSYS_CNC_TYPE.S30;
            case "31":
                return ODBSYS_CNC_TYPE.S31;
            case "32":
                return ODBSYS_CNC_TYPE.S32;
            case "35":
                return ODBSYS_CNC_TYPE.S35;
            case "0":
                return ODBSYS_CNC_TYPE.S0;
            case "PD":
                return ODBSYS_CNC_TYPE.PD;
            case "PH":
                return ODBSYS_CNC_TYPE.PH;
            case "PM":
                return ODBSYS_CNC_TYPE.PM;
            default:
                throw new ArgumentException("Invalid CNC type string");
        }
    }
    public enum ODBSYS_CNC_TYPE
    {
        S0 = 0, // Series 0i
        S15 = 15, // Series 15/15i
        S16 = 16, // Series 16/16i
        S18 = 18, // Series 18/18i
        S21 = 21, // Series 21/21i
        S30 = 30, // Series 30i
        S31 = 31, // Series 31i
        S32 = 32, // Series 32i
        S35 = 35, // Series 35i
    ...
    public static ODBSYS_MT_TYPE cnc_mt_type_convert(char[] value)
    {
        return Enum.Parse<ODBSYS_MT_TYPE>(new string(value).Trim(), true);
    }
    public enum ODBSYS_MT_TYPE
    {
        M = 1, // Machining center
        T = 2, // Lathe
        MM = 3, // M series with 2 path control
        TT = 4, // T series with 2/3 path control
        MT = 5, // T series with compound machining function
        P = 6, // Punch press
        L = 7, // Laser
        W = 8 // Wire cut
    }
    ...
    public static extern short cnc_getfigure(ushort FlibHndl,
       short a, out short b, out short c, out short d);
